 ...
 */
static _inline void __list_add(void * new,
	void * prev,
	void * next)
{
	((struct list_head*)next)->prev = (struct list_head*)new;
	((struct list_head*)new)->next = (struct list_head*)next;
	((struct list_head*)new)->prev = (struct list_head*)prev;
	((struct list_head*)prev)->next = (struct list_head*)new;
}

/*
 * Insert a new entry after the specified head..
 */
static _inline void list_add(void *new, void *head)
{
 ...
 */
static _inline void list_add_tail(void *new, void *head)
{
